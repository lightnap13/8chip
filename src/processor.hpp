...
namespace chip8
{
    ...
    class cProcessor
    {
      public:
        ...
        void execute_next_instruction(cRam* ram, cDisplay* display);
      ...
      private:
        ...
        void execute_opcode_EXXX(int16_t opcode);            // Needs keyboard
        void execute_opcode_EX9E(int16_t opcode);            // Needs keyboard
        void execute_opcode_EXA1(int16_t opcode);            // Needs keyboard
        void execute_opcode_FXXX(int16_t opcode, cRam* ram); // Needs timers, needs keyboard.
        void execute_opcode_FX07(int16_t opcode);            // Needs delay timer
        void execute_opcode_FX0A(int16_t opcode);            // Needs keyboard
